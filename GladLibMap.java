...
public class GladLibMap {
    ...
    for (int i = 0; i < labelused.size(); i++) {
        ArrayList words = myMap.get(labelused.get(i));
        sizeused = sizeused + words.size();
    }
    return sizeused;
    }
    ...
    public void makeStory(){
        ...
        System.out.println("Number of words used in all the Arraylists in the HashMap = " + totalWordsConsidered());
    }
